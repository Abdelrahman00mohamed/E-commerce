...
export default function Women() {
  let {productwomen,addProduct}=useContext(contextProduct)

  return (
    <>
  <Container>
  <h2 className='text-center mt-5 fw-bolder'>Women collection</h2>
<Row className='gy-5 my-4 align-items-center justify-content-center'>
  {productwomen.map((pro,i)=> <Col className='card offset-md-1  offset-sm-0' key={i} md='3'>
