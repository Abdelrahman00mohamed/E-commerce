...
export default function Men() {
  let {productMen,addProduct}=useContext(contextProduct)
  return (
    <>
    <Container >
<h2 className='text-center mt-5 fw-bolder'>Men collection</h2>

  <Row className='gy-5 my-4 align-items-center justify-content-center'>
    {productMen.map((pro,i)=> <Col className='card offset-md-1  offset-sm-0 ' key={i} md='3'>
   ...
   <Link className='btn btn-hov btn-info text-white ' onClick={()=>addProduct(pro)}> <i class="bi bi-cart3"></i> Add to cart</Link>
      ...
      <img className='w-100 sizhei mb-2' src={pro.image} alt='product'/>
